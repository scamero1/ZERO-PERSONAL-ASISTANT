...
tk.Label(root, text=f"Login: http://localhost:8501", font=("Arial", 8)).pack(pady=10)
tk.Label(root, text=f"Streamlit (IA) : http://localhost:8501", font=("Arial", 8)).pack(pady=10)
tk.Label(root, text=f"Login: http://localhost:8000", font=("Arial", 8)).pack(pady=10)
root.mainloop()